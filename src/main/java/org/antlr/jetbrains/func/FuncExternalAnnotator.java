 ...
 */
public class FuncExternalAnnotator extends ExternalAnnotator<PsiFile, List<FuncExternalAnnotator.Issue>> {
	...
	public List<Issue> doAnnotate(final PsiFile file) {
		Collection<? extends PsiElement> funcNameNodes =
			XPath.findAll(FuncLanguage.INSTANCE, file, "/script/function/ID");
		Collection<? extends PsiElement> funcCallNameNodes =
			XPath.findAll(FuncLanguage.INSTANCE, file, "//call_expr/ID");
