...
public abstract class FuncElementRef extends PsiReferenceBase<IdentifierPSINode> {
	public FuncElementRef(@NotNull IdentifierPSINode element) {
		/** WARNING: You must send up the text range or you get this error:
		 * "Cannot find manipulator for PsiElement(ID) in org.antlr.jetbrains.func.FuncElementRef"...
