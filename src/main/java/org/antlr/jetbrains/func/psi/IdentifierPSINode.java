...
import org.antlr.jetbrains.func.FuncParserDefinition;
import org.jetbrains.annotations.NonNls;
import org.jetbrains.annotations.NotNull;

import static org.antlr.jetbrains.func.parser.FuncParser.RULE_function_call_line;
import static org.antlr.jetbrains.func.parser.FuncParser.RULE_expr;
import static org.antlr.jetbrains.func.parser.FuncParser.RULE_statement;
...
public class IdentifierPSINode extends ANTLRPsiLeafNode implements PsiNamedElement {
	...
	public PsiElement setName(@NonNls @NotNull String name) throws IncorrectOperationException {
		...
		if ( elType instanceof RuleIElementType ) {
			...
			if ( ruleIndex == RULE_function_call_line ) {
				kind = "call ";
			}
